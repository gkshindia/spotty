        ...
        try:
            ...
            if 'resources' in template_data:
                for key, value in template_data['resources'].items():
                    if key not in workload_config['resources'] or not workload_config['resources'][key]:
            ...
            if 'parameters' in template_data and 'params' in workload_config:
                for param in template_data['parameters']:
                    if param['name'] not in workload_config['params'] and 'default' in param:
...
async def upload_workload_template(
    name: str = Form(...),
