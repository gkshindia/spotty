...
async def get_system_status_api(orchestrator: OrchestratorManager = Depends(get_orchestrator)):
    """Get overall system status"""
    return orchestrator.get_system_status()

@router.get("/resources")
async def get_resources_api(orchestrator: OrchestratorManager = Depends(get_orchestrator)):
